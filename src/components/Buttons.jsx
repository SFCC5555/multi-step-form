...
function handleBackButton() {
  ...
  return (
    <div className='absolute z-10 bottom-0 -translate-y-8 px-5 sm:px-52 md:px-64 sm:translate-x-28 sm:-translate-y-12 w-full sm:max-w-4xl flex items-center justify-between'>
