...
const AddOns = () => {
  ...
  const {period,onlineService,largerStorage,customizableProfile,setLocation,setSubmit} = useContext(AppContext);
  ...
  return (
    <section className='flex flex-col gap-4 h-full w-full sm:justify-start sm:gap-10'>
      ...
      {addOnsList.map(a=><div key={a.name} id={a.name} onClick={a.state.change} className='w-full flex items-center justify-between px-3 py-3 sm:py-2 lg:py-3 border-2 rounded-md hover:border-purple-800 cursor-pointer'>
